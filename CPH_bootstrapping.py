...
from surv_analysis_functs import prep_Xy_sksurv, fit_cph, bootstrap_model
...
save_name = 'CPH_' + clin_end + '_' + feat_type + '_' + combat
...
cph = fit_cph(X_train = curr_X_train, y_train = y_train, a = hyperparam_vals['alpha'], tie_type = 'breslow', iter_num = 100)
