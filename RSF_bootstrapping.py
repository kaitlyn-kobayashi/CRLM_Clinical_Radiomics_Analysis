...
from surv_analysis_functs import prep_Xy_sksurv, fit_rsf_model, bootstrap_model
...
save_name = 'RSF_' + clin_end + '_' + feat_type + '_' + combat
...
rsf = fit_rsf_model(X_train = curr_X_train, y_train = y_train, n_est = hyperparam_vals['n_estimators'], max_depth = hyperparam_vals['max_depth'], min_samp_split = hyperparam_vals['min_samples_split'], min_samp_leaf = hyperparam_vals['min_samples_leaf'], random_state = 42)
